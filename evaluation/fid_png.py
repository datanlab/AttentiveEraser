...
class InferenceDataset(Dataset):
    def __init__(self, datadir, inference_dir, eval_resolution=299, img_suffix='.png', inpainted_suffix='_removed.png'):
...
class Inferencedataset_local(InferenceDataset):
    def __init__(self, datadir, inference_dir, test_scene, eval_resolution=299, img_suffix='.png', inpainted_suffix='_removed.png'):
...
if __name__ == '__main__':
    ...
    dataset = InferenceDataset(args.datadir, args.inference_dir, eval_resolution=299, img_suffix='.png', inpainted_suffix=args.inpainted_suffix)
    dataset_local = Inferencedataset_local(args.datadir, args.inference_dir, args.test_scene, eval_resolution=299, img_suffix='.png', inpainted_suffix=args.inpainted_suffix)

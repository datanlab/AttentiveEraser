...
# 定义路径
source_folder = '/hy-tmp/6000_outputs'  # 替换为源文件夹的路径
destination_folder = '/hy-tmp/6000_outputs_filtered'  # 替换为目标文件夹的路径
txt_file_path = '/hy-tmp/DATA/mask_files_record.txt'  # 替换为记录mask文件名的txt文件路径
